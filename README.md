...
| **Method** | **URL**                                                                                               | **Headers**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
|------------|-------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **DELETE** | `{baseUrl}/api/v2/<company_portal_id>/authInfo/<mobile_token>` | `mobile-domain: <domain_name>`<br>`mobile-authorization: <mobile_token>`<br>`Content-Type: application/json`<br>`Authorization: Bearer <access_token>` |
